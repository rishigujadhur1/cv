                ...
                <div class="col-lg-9 col-md-8">
                    <div class="mx-646">
                        ...
                        <h2 class="lg:tw-mb-10 tw-mb-6 {{ $setting->nav_color ? '' : $setting->nav_color }}">
                         Mauritius Online Advertising</h2>
                        <p class="body-font-2 text-gray-500 rt-mb-0">
                         The online advertising partner you can trust. JobHelp.IT is a comprehensive SAAS platform developed by Devsia for Job Seekers and Recruiters based in Mauritius. Devsia is a renowned advertising agency with a specialization in web development based in Mauritius. 
						 With its expertise in the digital realm, Devsia has created a user-friendly interface that allows job seekers to easily search and apply for jobs. 
						 As a product of Devsia, JobHelp.it is backed by the company's commitment to excellence in design and functionality. 
						 Devsia's track record of developing innovative and high-quality web applications ensures that JobHelp.it is a reliable and efficient tool for both job seekers and employers alike.
						 <br/>
							<a target="_blank" href="http://devsia.jobhelp.it/"> Click here to find more about Devsia </a>
                        </p>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-md-6">
                        ...
                        <h3 class="lg:tw-mb-8 tw-mb-4">Our services assist you in expanding your customer base.</h3>
                        <p class="body-font-2 text-gray-500 lg:tw-mb-0 tw-mb-4">
                           Our goal is to enhance your online presence by utilizing social media platforms to reach a broader audience, and implementing effective Google and Facebook strategies to convert website traffic. We believe that search engine optimization involves more than just incorporating relevant keywords, but rather requires a comprehensive online marketing approach. Our objective is to optimize your web visibility on search engines such as Google, Yahoo, and Bing, in order to increase your chances of attracting potential clients and ultimately, expanding your business online.
                        </p>
                    </div>
                    <div class="col-md-6">
                        <div>
